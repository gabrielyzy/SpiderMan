...
SpidermanGame.prototype.load = function() {
	...
	'<div class="spiderman-game-menu-container">' +
		'<div class="spiderman-game-menu-title">Derrota</div>' +
		'<div class="spiderman-game-menu-title">PONTUAÇÃO FINAL: <span class="spiderman-game-score">0</span></div>' +
		'<div class="spiderman-game-menu-button spiderman-game-menu-button-restart">REINICIAR</div>' +
	'</div>';
